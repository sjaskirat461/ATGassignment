  ...
  return (
    <div className="w-[5/12] md:w-6/12 md:ml-24 shadow-[0_3px_10px_rgb(0,0,0,0.2)] p-0 ">
      <div className="flex flex-col p-6">
        ...
        <p className="text-l font-bold border-2 border-gray-300 rounded-md -z-[1]  p-2 mt-6  flex justify-center items-center text-[#5C5C5C] text-green-400 ">
          {operation}
        </p>
